...
func newStressTestStash(t *testing.T, cfg Config) (*Vault, *sqlx.DB) {
	t.Helper()
...
func statsFromReadDir(t *testing.T, s *Vault, dir string) ([]File, error) {
	t.Helper()
