...
# Vault
lib.bao_vault_create.argtypes = [ctypes.c_char_p, ctypes.c_longlong, ctypes.c_longlong, ctypes.c_char_p]
lib.bao_vault_create.restype = Result
lib.bao_vault_open.argtypes = [ctypes.c_char_p, ctypes.c_char_p, ctypes.c_longlong, ctypes.c_longlong]
lib.bao_vault_open.restype = Result
lib.bao_vault_close.argtypes = [ctypes.c_longlong]
lib.bao_vault_close.restype = Result
lib.bao_vault_syncAccess.argtypes = [ctypes.c_longlong, ctypes.c_char_p, ctypes.c_char_p]
...
lib.bao_vault_waitFiles.argtypes = [ctypes.c_longlong, ctypes.c_longlong, ctypes.c_char_p]
lib.bao_vault_waitFiles.restype = Result
lib.bao_vault_sync.argtypes = [ctypes.c_longlong]
lib.bao_vault_sync.restype = Result
lib.bao_vault_setAttribute.argtypes = [ctypes.c_longlong, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_char_p]
...
lib.bao_vault_read.argtypes = [ctypes.c_longlong, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_char_p]
lib.bao_vault_read.restype = Result
lib.bao_vault_write.argtypes = [ctypes.c_longlong, ctypes.c_char_p, ctypes.c_char_p, Data, ctypes.c_char_p]
lib.bao_vault_write.restype = Result
lib.bao_vault_delete.argtypes = [ctypes.c_longlong, ctypes.c_char_p, ctypes.c_char_p]
...
lib.bao_replica_sync.argtypes = [ctypes.c_longlong, ctypes.c_char_p]
