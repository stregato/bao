...
public interface BaoLibrary extends Library {
    ...
    Result bao_vault_create(String identity, long storeH, long dbH, String settingsJson);
    Result bao_vault_open(String identity, String author, long storeH, long dbH);
    Result bao_vault_close(long baoH);
    Result bao_vault_syncAccess(long baoH, String optionsJson, String changesJson);
    ...
    Result bao_vault_setAttribute(long baoH, String optionsJson, String name, String value);
    ...
    Result bao_vault_read(long baoH, String name, String dest, String optionsJson);
    Result bao_vault_write(long baoH, String dest, String src, Data attrs, String optionsJson);
    Result bao_vault_delete(long baoH, String name, String optionsJson);
